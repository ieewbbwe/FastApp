 ...
 */
public class LoopPagerAdapterWrapper<T> extends BasicPageAdapter<T> {

    private BasicPageAdapter<T> mAdapter;
    ...
    public LoopPagerAdapterWrapper(
            Context ctx,
            BasicPageAdapter<T> adapter) {
        super(ctx);
