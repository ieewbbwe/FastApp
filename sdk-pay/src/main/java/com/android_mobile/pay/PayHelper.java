...
public class PayHelper implements IPayCore {
     ...
     */
    @Override
    public Observable<String> createOrderInfo(String orderNumber, long incomeAmt) {
     ...
     */
    @Override
    public void aliPrePay(final String orderNum, long incomeAmt) {
     ...
     */
    @Override
    public void wxPrePay(String orderNumber, long incomeAmt) {
