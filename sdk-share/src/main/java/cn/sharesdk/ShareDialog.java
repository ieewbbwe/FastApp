...
public class ShareDialog extends Dialog implements AdapterView.OnItemClickListener {
    ...
    private void addSharePlatform() {
        ...
        platforms.add(new SharePlatform(R.drawable.ssdk_oks_classic_wechat, getString(R.string.ssdk_wechat), WE_CHART));
        platforms.add(new SharePlatform(R.drawable.ssdk_oks_classic_wechatmoments, getString(R.string.ssdk_wechatmoments), WE_CIRCLE));
        platforms.add(new SharePlatform(R.drawable.ssdk_oks_classic_qq, getString(R.string.ssdk_share_to_qq), TENCENT));
        platforms.add(new SharePlatform(R.drawable.ssdk_oks_classic_email, getString(R.string.ssdk_email), EMAIL));
        platforms.add(new SharePlatform(R.drawable.ssdk_oks_classic_sinaweibo, getString(R.string.ssdk_sinaweibo), SINA));
